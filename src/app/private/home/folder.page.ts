...
import { DLScanData, ScanDataType } from 'src/app/interfaces/interface';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonicModule,          // Import IonicModule to include all Ionic components and services
